...
Here, `results_list` is a list with `r length(results_list)` elements, one for each of the datasets that were analyzed. Each individual element is a tibble with the same list columns, `results` and `metadata`.
