...
If you are only contributing code to this project, and don't intend to run anything, you generally don't need any additional packages, since the documentation will be written as comments in the R scripts. If you are also planning to run the analysis, please see the instructions in the [README](README.md#running-the-code) for more details.
